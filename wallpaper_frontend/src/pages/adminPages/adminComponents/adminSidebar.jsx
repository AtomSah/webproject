...
import comixNook from "../../../../public/Logos/wall-logo.png"
import adminImage from "../../../../public/Logos/wall-logo.png"
            ...
            <div className={"admin-sidebar bg-gray-200 border-r-2 border-gray-800"}>
                ...
                <div className={"sidebar-btn-div"}>
                    <div className={"sidebar-btn flex items-center rounded-xl p-2 cursor-pointer backdrop-blur-3xl "}>
                        ...
                        <h1 className={"gilroy-semibold text-sm mr-1"}>Atom Sah <h4 className={"-mt-1"} style={{fontSize:"0.6rem"}}>atomsah567890-@gmail.com</h4> </h1>
